...
public class MovieUi {
	...
	private Font font0 = new Font("Arial", 0, 40);
	private Font font1 = new Font("Arial", 0, 28);
	...
	private JButton jreport=new JButton("Post Comment");//评论
	private JTextArea jmDetail = new JTextArea(50, 50);
	private JButton jreturn = new JButton("Back to Home page");
	private JButton jBuy = new JButton("Watch Movie");
	...
	if(canreport) {
	  if("".equals(jcommentcontent.getText())) {
		...
		if(commentservice.addComment(comm)) {
		  ...
		  JOptionPane.showMessageDialog(null, "You've commented this movie");
	  }
	}
