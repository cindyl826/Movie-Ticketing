...
public class AddMovie extends JInternalFrame {
	...
	public AddMovie() {
		...
		JLabel movieNameLabel = new JLabel("Name:");
		movieNameLabel.setFont(new Font("Arial", Font.PLAIN, 20));
		
		movieNameText = new JTextField();
		movieNameText.setFont(new Font("Arial", Font.PLAIN, 20));
		movieNameText.setColumns(10);
		
		JLabel movielanglabel = new JLabel("Language:");
		movielanglabel.setFont(new Font("Arial", Font.PLAIN, 20));
		
		movielangText = new JTextField();
		movielangText.setFont(new Font("Arial", Font.PLAIN, 20));
		movielangText.setColumns(10);
		
		JLabel movieLoaLabel = new JLabel("Region:");
		movieLoaLabel.setFont(new Font("Arial", Font.PLAIN, 20));
		
		movieLoaText = new JTextField();
		movieLoaText.setFont(new Font("Arial", Font.PLAIN, 20));
		movieLoaText.setColumns(10);
		
		JLabel picaddressLabel = new JLabel("Poster:");
		picaddressLabel.setFont(new Font("Arial", Font.PLAIN, 20));
		
		picaddressText = new JTextField();
		picaddressText.setFont(new Font("Arial", Font.PLAIN, 20));
		picaddressText.setColumns(10);
		picaddressText.setText("images/");
		...
		JLabel movietypeLabel = new JLabel("Category:");
		movietypeLabel.setFont(new Font("Arial", Font.PLAIN, 20));
		
		 movietypeBox = new JComboBox();
		 movietypeBox.setFont(new Font("Arial", Font.PLAIN, 20));
		 movietypeBox.addItem("Sci-Fi");
		 movietypeBox.addItem("Action");
		 movietypeBox.addItem("Romance");
		 movietypeBox.addItem("Drama");
		 movietypeBox.addItem("Anime");
		...
		scoreText.setColumns(10);
		 ...
		 detailtextArea.setFont(new Font("Arial", Font.PLAIN, 20));
