...
public class TicketManager extends JInternalFrame {
	...
	public TicketManager() {
		...
		deletButton.setFont(new Font("Arial", Font.PLAIN, 20));
		
		sIdtext = new JTextField();
		sIdtext.setFont(new Font("Arial", Font.PLAIN, 20));
		sIdtext.setColumns(10);
		
		JLabel lblNewLabel = new JLabel("Session NO.:");
		...
		tickettable = new JTable(){
			...
			tickettable.setModel(new DefaultTableModel(
					...
					new String[] {
						"Ticket NO.", "User NO.", "Session NO.","Seat NO."
					}
				) {
			...
			tickettable.getTableHeader().setFont(new Font("Arial", 1, 20));
